...
Posicion deseada: Full stack, en .
...
- Vistas cargadas desde un helper, de esta forma aumenta la flexibilidad debido a que la configuracion se encuentra centralizada
...
3. La Request filtra, sanitiza y convierte la URL en controlador, metodo y (en caso de que existan) parametros.
...
3. Modificar el archivo install/config.ini y definir lo siguiente:
    ...
    (LAS SIGUIENTES DOS ES IMPORTANTE QUE FINALICEN EN "/")
...
6. Una vez hecho esto se podrá acceder a la app web desde xampp y comenzaremos a ver datos con los que podemos interactuar.
